...
CosmicMath = {
  ...
  courses: {
    Topics: [
      ...
      "Topics.Coordinate Geometry.Polygon area.Level 1",
      "Topics.Coordinate Geometry.Polygon area.Level 2",
      "Topics.Coordinate Geometry.Polygon area.Level 3"
    ],
  },
  beta: {
  ...
  appHelp: {
    ...
    ...(() => {
      const help = `<i>Currently, not all polygons formed by the given vertex coordinates are valid. This issue can be resolved by filtering out invalid combinations of vertices that do not create proper polygons—a fix that will be implemented soon. For now, please use this app solely to practice applying the formula.</i><br><br>You can use the shoelace formula to calculate the area of any polygon with the coordinates of its vertices. Here is the formula:<br><br> <math xmlns="http://www.w3.org/1998/Math/MathML" display="block" style=" font-size: 20px;"> <mi>Area</mi> <mo>=</mo> <mfrac> <mn>1</mn> <mn>2</mn> </mfrac> <mo>&#x2223;</mo> <mo>[</mo> <munderover> <mo>&#x2211;</mo> <mi>i</mi> <mo>=</mo> <mn>1</mn> <mo>&#x2026;</mo> <mi>n</mi> </munderover> <mo>(</mo> <msub> <mi>x</mi> <mi>i</mi> </msub> <msub> <mi>y</mi> <mi>i+1</mi> </msub> <mo>-</mo> <msub> <mi>y</mi> <mi>i</mi> </msub> <msub> <mi>x</mi> <mi>i+1</mi> </msub> <mo>)</mo> <mo>]</mo> <mo>&#x2223;</mo> </math>`;
      const keys = [
      ...
      return Object.fromEntries(keys.map(key => [key, { content: help }]));
    })()
  },
  ...
  createSum: function (input, address) {
    ...
    document.querySelector("#appName").innerHTML =
      ...
      (async () => {
        const div = await waitForElement('#appName > div');
        div.onclick = () => $.infoPanel(1,address.split("_").join(" > "),helpcontent);
      })()
      /* document
