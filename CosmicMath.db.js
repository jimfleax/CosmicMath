const $db = {
  ...
  Home_Arithmetic_Divide: {
    question: function () {
      ...
      Number.isInteger(x / y)
        ...
        : x / y === Infinity
        ? (this.answer = "I")
        : (this.answer = Number.parseInt(x / y) + "," + (x % y));
      return x + " ÷ " + y;
    },
    answer: null,
    interface: function (name, address) {
  ...
  Home_Algebra_Quadraticequations: {
    ...
    question: function () {
      ...
      return (
        "𝑥² " +
        (fixSign(-(x + y)) === undefined || !fixSign(-(x + y))
          ? this.question()
          : fixSign(-(x + y))) +
        "𝑥 " +
        (fixSign(x * y) === undefined || !fixSign(x * y)
  ...
  Home_Arithmetic_Convert_Decimal: {
    ...
    interface: function (name, address) {
      ...
      $$[0] = new Text(quest[0], "");
      $$[1] = new Line(
        `height: 4px;width: 1.3em;background: #596299;border: none;border-radius: 5em;margin: auto;`
      );
      $$[2] = new Text(quest[1], "");
      $$[3] = new Break();
      $$[4] = new Input();
  ...
  Home_Arithmetic_Factorsanddivisors: {
    question: function () {
      ...
      return [
        "How many divisors does " + num + " have?",
        "List the divisors of " + num,
      ];
    },
    answer: null,
    interface: function (name, address) {
              ...
              if (i.which == 13) {
                if (
                  $.submit(
                    name,
                    address,
                    parseFloat(document.querySelector("#response").value),
                    ans,
                    false,
                    false
                  ) === "correct"
  ...
  Home_Percentages_Type1: {
    question: function () {
      ...
      this.answer =
        creaseType === "increased"
          ? Number((a + a * (b / 100)).toFixed(2).toString())
          : Number((a - a * (b / 100)).toFixed(2).toString());
  ...
  Home_Series_Arithmeticprogression: {
    ...
    interface: function (name, address) {
      ...
      $$[2] = new Text(
        "T",
        "font-weight: 900; font-size: 47px; font-style: italic; font-family: georgia;"
      );
            ...
            e.onkeypress = function (i) {
              ...
              if (i.which == 13) {
                $.submit(
                  ...
                  address,
                  [
                    parseFloat(document.querySelectorAll("#response")[0].value),
                    parseFloat(document.querySelectorAll("#response")[1].value),
                  ].join(),
                  ans.join()
                );
              }
  ...
  Home_Algebra_Cubicexpressions_Cubicfactorisation: {
    question: function () {
      ...
      return (
        (a1 * a2 * a3 === 1 ? "" : a1 * a2 * a3) +
        "𝑥³ + " +
        (a1 * a2 * b3 + a1 * a3 * b2 + a2 * a3 * b1 === 1
          ? ""
          : a1 * a2 * b3 + a1 * a3 * b2 + a2 * a3 * b1) +
        "𝑥² + " +
        (a1 * b2 * b3 + a2 * b1 * b3 + a3 * b1 * b2 === 1
          ? ""
  ...
  Home_Simultaneousequations_Type1: {
    question: function () {
      var x = $.random(10, true, 0),
        y = $.random(10, true, 0),
        b = $.random(10, true, 0),
            ...
            e.onkeypress = function (i) {
              ...
              if (i.which == 13) {
                $.submit(
                  ...
                  address,
                  [
                    document.querySelectorAll("#response")[0].value,
                    document.querySelectorAll("#response")[1].value,
                  ].join(),
                  ans.join()
                );
              }
  ...
  Home_Simultaneousequations_Type2: {
    question: function () {
      var x = $.random(10, true, 0),
        y = $.random(10, true, 0),
        z = $.random(10, true, 0),
              ...
              if (i.which == 13) {
                $.submit(
                  ...
                  [
                    document.querySelectorAll("#response")[0].value,
                    document.querySelectorAll("#response")[1].value,
                    document.querySelectorAll("#response")[2].value,
                    document.querySelectorAll("#response")[3].value,
                  ].join(),
                  ans.join()
                );
              }
  ...
  Home_Simultaneousequations_Linearequations: {
    question: function () {
      ...
      //var slope = (b - d) / (a - c);
      this.answer = formatCoef(
        frac(undefined, undefined, parseFloat((b - d) / (a - c)).toFixed(5))
      )
        ? (formatCoef(
            frac(undefined, undefined, parseFloat((b - d) / (a - c)).toFixed(5))
          ) === " "
          ...
          (parseFloat(fixSign(b - (a * (b - d)) / (a - c))).toFixed(5) *
            100000 <
          0
            ? frac(
                undefined,
      ...
      this.answer.length >= 7
        ? (this.question(), console.log("Long answer"))
        : null;
  ...
  Home_Circletheorem_Radianstodegrees: {
    ...
    interface: function (name, address) {
      ...
      $$[1] = new Line(
        `height: 4px;width: ${
          Math.max(questionArr[0].length, questionArr[1].length) * (311 / 11) +
          20
        }px;background: #596299;border: none;border-radius: 5em;margin: auto;`
      );
      $$[2] = new Text(questionArr[1], "");
      $$[3] = new Break();
  ...
  Home_Circletheorem_Sectors: {
    question: function () {
      ...
      if (r == 0) {
        this.answer = arc;
        return (
          "What is the arc length of a sector with angle " +
          angle +
          " radians and radius " +
          radius +
          "cm?"
        ...
        this.answer = radius;
        return (
          "What is the radius of a circle with sector angle " +
          angle +
        ...
        this.answer = angle;
        return (
          "What is the angle of a sector with radius " +
          radius +
          "cm and arc length " +
          arc +
          "cm?"
        ...
        return (
          "What is the area of a sector with angle " +
          angle +
          " radians and radius " +
          radius +
          "cm?"
  ...
  Home_Statistics_Binomialdistribution: {
    question: function () {
      ...
      this.answer = parseFloat(
        (factorial(x) / (factorial(z) * factorial(x - z))) *
          Math.pow(y / 100, z) *
          Math.pow(1 - y / 100, x - z).toFixed(2)
      );
      return (
        "A biased coin has " +
        y +
        "% chance of showing heads in each toss. Find the probability that " +
        x +
        " tosses will result in exactly " +
        z +
        " heads."
      );
    },
  ...
  Home_Logarithms_Level1: {
    question: function () {
      ...
      return [
        base,
        sign
          ? `<mfrac><msup><mn>1</mn></msup><mn>${num}</mn></mfrac>`
          : `<mn>${num}</mn>`,
      ];
            ...
            e.onkeypress = function (i) {
              ...
              if (i.which == 13) {
                $.submit(
                  name,
                  address,
                  parseVal(document.querySelector("#response").value),
                  parseVal(ans)
                );
              }
            };
  ...
  Home_Logarithms_Level2: {
    question: function () {
      ...
      return [
        qbase,
        sign
          ? `<mfrac><msup><mn>1</mn></msup><mn>${nnum || num}</mn></mfrac>`
          : `<mn>${nnum || num}</mn>`,
      ];
      //return render("div", `<math xmlns="http://www.w3.org/1998/Math/MathML"> <msub> <mi>log</mi> <mn>${quest[0]}</mn> </msub> <mn>${quest[1]}</mn> </math>`)
    },
  ...
  Home_Simultaneousequations_Type3: {
    question: function () {
      ...
      this.answer = [x, y];
      return (
        '<span style="font-family:KaTeX_Main;">' +
        first_lhs +
        " = " +
        first_rhs +
        "<br>" +
  ...
  Home_Simultaneousequations_Type4: {
    question: function () {
      ...
      var sec_rhs = m * x + n * y;
      var sec_lhs = `${formatCoef(m)}x ${putSign(n)}y`;
      this.answer = [x, y];
      return (
        '<span style="font-family:KaTeX_Main;">' +
        first_lhs +
  ...
  Home_Simultaneousequations_Type5: {
    question: function () {
      ...
      var sec_rhs = m ** y + n * x;
      var sec_lhs = `${m}<sup>y</sup> ${putSign(n)}x`;
      this.answer = [x, y];
      return (
        '<span style="font-family:KaTeX_Main;">' +
        first_lhs +
